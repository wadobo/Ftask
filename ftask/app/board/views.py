...
from .board_views import shared_boards
...
board.add_url_rule(shared_boards.path, 'shared_boards', shared_boards)
...
from .task_views import assigned_tasks
from .task_views import comment_task
...
board.add_url_rule(assigned_tasks.path, 'assigned_tasks', assigned_tasks)
board.add_url_rule(comment_task.path, 'comment_task', comment_task)
